...
!function(){function e(e){if(0!=s){s=0;var i=($(".imgBox").size(),$(".imgBox.currSlider")),t=i.index(),a=e.index();if($(".bottonBarInner.currBottonbar").removeClass("currBottonbar"),$(".bottonBarInner").eq(a).addClass("currBottonbar"),t>a){i.prev();i.animate({left:"570px"}),e.css({left:-570}),e.addClass("currSlider"),e.animate({left:"0"}),setTimeout(function(){i.removeClass("currSlider"),s=1},500)}if(a>t){i.next();i.animate({left:"-570px"}),e.css({left:570}),e.addClass("currSlider"),e.animate({left:"0"}),setTimeout(function(){i.removeClass("currSlider"),s=1},500)}}}function i(e,i,t,a){if(0!=s){if(s=0,!e.eq(0).is(i)){if(e.last().is(i)){var r=i.first(),o=i.last();e.first().addClass("selectedMedia"),o=e.first(),o.css({left:a});var n=o.position().left-t;o.animate({left:n+"px"});for(var l=r,d=0;d<i.size();d++){var n=l.position().left-t;l.animate({left:n+"px"}),l=l.next()}return void setTimeout(function(){r.removeClass("selectedMedia"),s=1},500)}var r=i.first(),o=i.last();o=o.next(),o.addClass("selectedMedia"),i=i.add(o),o.css({left:a});for(var l=i.first(),d=0;d<i.size();d++){var n=l.position().left-t;l.animate({left:n+"px"}),l=l.next()}return void setTimeout(function(){r.removeClass("selectedMedia"),s=1},500)}if(e.eq(0).is(i)){if(e.last().is(i)){for(var f=e.last(),c=0;f.is(i);)f=f.prev(),c++;for(var r=f.next(),l=e.last(),d=0;c>d;d++){var n=l.position().left-t;l.animate({left:n+"px"}),l=l.prev()}for(c=0,f=e.first();f.is(i);)c++,f=f.next();var o=f;o.addClass("selectedMedia"),c++,i=i.add(o),o.css({left:a});for(var l=e.first(),d=0;c>d;d++){var n=l.position().left-t;l.animate({left:n+"px"}),l=l.next()}return void setTimeout(function(){r.removeClass("selectedMedia"),s=1},500)}var r=i.first(),o=i.last();o=o.next(),o.addClass("selectedMedia"),i=i.add(o),o.css({left:a});for(var l=i.first(),d=0;d<i.size();d++){var n=l.position().left-t;l.animate({left:n+"px"}),l=l.next()}return void setTimeout(function(){r.removeClass("selectedMedia"),s=1},500)}}}function t(e,i,t,a){if(0!=s){if(s=0,!e.eq(0).is(i)){if(e.last().is(i)){var r=i.first(),o=i.last();r=r.prev(),r.addClass("selectedMedia"),i=i.add(r),r.css({left:a});for(var n=i.first(),l=0;l<i.size();l++){var d=n.position().left+t;n.animate({left:d+"px"}),n=n.next()}return void setTimeout(function(){o.removeClass("selectedMedia"),s=1},500)}var r=i.first(),o=i.last();r=r.prev(),r.addClass("selectedMedia"),i=i.add(r),r.css({left:a});for(var n=i.first(),l=0;l<i.size();l++){var d=n.position().left+t;n.animate({left:d+"px"}),n=n.next()}return void setTimeout(function(){o.removeClass("selectedMedia"),s=1},500)}if(e.eq(0).is(i)){if(e.last().is(i)){for(var f=e.last(),c=0;f.is(i);)f=f.prev(),c++;var r=f;r.addClass("selectedMedia"),c++,i=i.add(r),r.css({left:a});for(var n=e.last(),l=0;c>l;l++){var d=n.position().left+t;n.animate({left:d+"px"}),n=n.prev()}for(c=0,f=e.first();f.is(i);)c++,f=f.next();for(var o=f.prev(),n=e.first(),l=0;c>l;l++){var d=n.position().left+t;i.eq(l).animate({left:d+"px"}),n=n.next()}return void setTimeout(function(){o.removeClass("selectedMedia"),s=1},500)}var o=i.first(),r=i.last();e.last().addClass("selectedMedia"),o=e.last(),o.css({left:a}),i=i.add(o);var d=o.position().left+t;o.animate({left:d+"px"});for(var n=i.first(),l=1;l<i.size();l++){var d=n.position().left+t;n.animate({left:d+"px"}),n=n.next()}return void setTimeout(function(){r.removeClass("selectedMedia"),s=1},500)}}}var s;$("input").focus(function(){$(".hot-words").css("display","none")}).blur(function(){$(".hot-words").css("display","block")}),$("#ad1Close").click(function(){$(".ad1").css("visibility","hidden")}),$("#ad2Close").click(function(){$(".ad2").css("visibility","hidden")}),$(window).scroll(function(){$(window).scrollTop()>=300?$(".ad3s.add31").css("visibility","visible"):$(".ad3s.add31").css("visibility","hidden")}),$(".ad3s.add31").click(function(){var e=setInterval(function(){$(window).scrollTop($(window).scrollTop()-100),0==$(window).scrollTop()&&clearInterval(e)},10)}),$(".hotlessionbox").mouseenter(function(){var e=$(this);e.addClass("hotlessionboxFocus").siblings().removeClass("hotlessionboxFocus"),$("#"+e.attr("id")+"Box").addClass("hot-lessionbox-focus").siblings().removeClass("hot-lessionbox-focus")}),setInterval(function(){var i=$(".imgBox").size(),t=$(".imgBox.currSlider").index();if(t+1==i)var s=$(".imgBox").first();else var s=$(".imgBox.currSlider").next();e(s)},6e3),$("#rightSidebar").click(function(){var i=$(".imgBox").size(),t=$(".imgBox.currSlider").index();if(t+1==i)var s=$(".imgBox").first();else var s=$(".imgBox.currSlider").next();e(s)}),$("#leftSidebar").click(function(){var i=$(".imgBox.currSlider"),t=i.index();if(0==t)var s=$(".imgBox").last();else var s=$(".imgBox.currSlider").prev();e(s)}),$(".bottonBarInner").click(function(){e($(".imgBox").eq($(this).index()))}),$("#enterpriseRightBar").click(function(){var e=$(".entermedia"),t=$(".entermedia.selectedMedia"),s=159,a=954;i(e,t,s,a)}),$("#enterpriseLeftBar").click(function(){var e=$(".entermedia"),i=$(".entermedia.selectedMedia"),s=159,a=-159;t(e,i,s,a)}),$("#univerRightBar").click(function(){var e=$(".univermedia"),t=$(".univermedia.selectedMedia"),s=137,a=954;i(e,t,s,a)}),$("#univerLeftBar").click(function(){var e=$(".univermedia"),i=$(".univermedia.selectedMedia"),s=137,a=-137;t(e,i,s,a)}),$("#mediaRightBar").click(function(){var e=$(".media"),t=$(".media.selectedMedia"),s=159,a=954;i(e,t,s,a)}),$("#mediaLeftBar").click(function(){var e=$(".media"),i=$(".media.selectedMedia"),s=159,a=-159;t(e,i,s,a)})}();